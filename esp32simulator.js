...
const mqttClient = mqtt.connect('tcp://127.0.0.1:1883');
const publishTopic = "Project3-iot/data";
const subscribeTopic = "Project3/update/command"
...
mqttClient.on('message', (subscribeTopic, payload) => {
    try {
        ...
        let embedId = jsonMessage.embedId;
